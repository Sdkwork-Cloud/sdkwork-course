...
This directory is the local SDKWork component contract for `@sdkwork/course-contracts`.

- Component root: `sdkwork-course/packages/common/course/sdkwork-course-contracts`
