# @sdkwork/course-contracts

Domain: content
Capability: course-contracts
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/course-contracts`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
