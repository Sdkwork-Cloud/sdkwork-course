...
This directory is the local SDKWork component contract for `sdkwork_course`.

- Component root: `sdkwork-course/packages/native-rust/course/sdkwork-course-rust`
