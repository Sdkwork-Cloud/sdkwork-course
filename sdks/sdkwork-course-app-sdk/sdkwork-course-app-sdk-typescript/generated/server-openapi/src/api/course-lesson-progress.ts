...
export interface CourseLessonProgressUpdateParams {
  idempotencyKey?: string;
}

export class CourseLessonProgressApi {
  private client: HttpClient;
  public readonly watchPositions: CourseLessonProgressWatchPositionsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.watchPositions = new CourseLessonProgressWatchPositionsApi(client);
  }
