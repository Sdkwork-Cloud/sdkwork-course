...
export class CourseEnrollmentsCurrentApi {
...
export class CourseEnrollmentsApi {
  private client: HttpClient;
  public readonly current: CourseEnrollmentsCurrentApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.current = new CourseEnrollmentsCurrentApi(client);
  }
...
export function createCourseEnrollmentsApi(client: HttpClient): CourseEnrollmentsApi {
  return new CourseEnrollmentsApi(client);
}
