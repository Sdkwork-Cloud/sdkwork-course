...
export class CourseApplicationsCurrentApi {
...
export interface CourseApplicationsCreateParams {
  idempotencyKey: string;
}

export class CourseApplicationsApi {
  private client: HttpClient;
  public readonly current: CourseApplicationsCurrentApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.current = new CourseApplicationsCurrentApi(client);
  }
