...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/course-app-sdk" }
        "rust" { return "sdkwork-course-app-sdk" }
        default { return "sdkwork-course-app-sdk-$Language" }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-course-app-api.sdkgen.yaml"
$SdkName = "sdkwork-course-app-sdk"
