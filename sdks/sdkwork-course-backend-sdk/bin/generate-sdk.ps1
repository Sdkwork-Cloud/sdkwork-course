...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/course-backend-sdk" }
        "rust" { return "sdkwork-course-backend-sdk" }
        default { return "sdkwork-course-backend-sdk-$Language" }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-course-backend-api.sdkgen.yaml"
$SdkName = "sdkwork-course-backend-sdk"
