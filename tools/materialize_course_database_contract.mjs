...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_course_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'course_', owner: 'course-platform', domain: 'course' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into course database contract\n`);
