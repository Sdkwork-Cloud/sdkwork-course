...
pub fn translate_bind_placeholders(sql: &str) -> String {
...
impl CourseSqlBinding for super::course_repository::PostgresCourseRepository {
    fn bind_sql<'a>(&self, sql: &'a str) -> Cow<'a, str> {
        Cow::Owned(translate_bind_placeholders(sql))
    }
}

#[cfg(test)]
mod tests {
    use super::translate_bind_placeholders;

    #[test]
    fn translate_bind_placeholders_rewrites_numbered_bindings() {
        assert_eq!(
            translate_bind_placeholders(
