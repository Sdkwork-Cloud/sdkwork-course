...
| --- | --- | --- | --- | --- |
| sdkwork-course-h5 | h5 | yes | sdkwork-course-h5 h5 application root. | `sdkwork-course-h5/` |
| sdkwork-course-mini-program | mini-program | yes | sdkwork-course-mini-program mini-program application root. | `sdkwork-course-mini-program/` |
| sdkwork-course-pc | pc | yes | sdkwork-course-pc pc application root. | `sdkwork-course-pc/` |
